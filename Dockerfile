...
# Manually download tailwind binary to avoid GitHub rate limits
RUN mkdir -p _build && \
    wget -q -O _build/tailwind-linux-x64 https://github.com/tailwindlabs/tailwindcss/releases/download/v3.4.0/tailwindcss-linux-x64 && \
